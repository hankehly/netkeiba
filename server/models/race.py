...
class Race(BaseModel):
    ...
    racetrack = models.ForeignKey('Racetrack', on_delete=models.PROTECT)
    impost_category = models.ForeignKey('ImpostCategory', on_delete=models.PROTECT)
    course_type = models.ForeignKey('CourseType', on_delete=models.PROTECT)
    distance = models.PositiveSmallIntegerField()
    date = models.DateField()
    weather = models.ForeignKey('WeatherCategory', on_delete=models.PROTECT)
